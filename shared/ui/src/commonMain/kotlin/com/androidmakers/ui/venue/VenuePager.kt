...
fun VenuePager(modifier: Modifier = Modifier) {
  ...
  Column(
    ...
    VenueTabRow(titles = titles, pagerState = pagerState)

    HorizontalPager(
      state = pagerState,
    ) { page ->
      VenueOrFloorPlanPage(page = page, viewModel = viewModel)
    }
  }
}

@Composable
private fun VenueTabRow(
  titles: List<org.jetbrains.compose.resources.StringResource>,
...
@Composable
private fun VenueOrFloorPlanPage(
  page: Int,
